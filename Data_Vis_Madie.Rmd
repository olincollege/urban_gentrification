...
```{r}
residential_developments = read_csv("/home/mtong1/data-science/urban_gentrification/data/clean_data/residential_developments.csv")
...
```{r}
units_low_income_421a = read_csv("/home/mtong1/data-science/urban_gentrification/data/clean_data/units_low_income_421a.csv")
...
```{r}
borough_median_rent = read_csv("/home/mtong1/data-science/urban_gentrification/data/clean_data/borough_median_rent.csv")
...
```{r}
brooklyn_median_rent = read_csv("/home/mtong1/data-science/urban_gentrification/data/clean_data/brooklyn_median_rent.csv")
...
```{r}
diff_median_rent = read_csv("/home/mtong1/data-science/urban_gentrification/data/clean_data/diff_median_rent.csv")

ggplot(diff_median_rent, aes(x=unit_nums, y=diff)) +
  geom_point(alpha=0.3) + 
  geom_smooth(method="lm", se=FALSE) + 
  geom_label_repel(label=diff_median_rent$Name, size = 2.5) +
  labs(x="Number of 421a Units", y="Median Rent Increase($)", title="Linear Model of Brooklyn's 421a Units and Median Rent Increase per Commu")
```