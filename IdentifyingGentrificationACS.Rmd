...
```
```{r}
ggplot(property_value_growth %>% filter(neighborhood == "WILLIAMSBURG-NORTH" | neighborhood == "WILLIAMSBURG-EAST"| neighborhood == "WILLIAMSBURG-CENTRAL" | neighborhood == "WILLIAMSBURG-SOUTH"), aes(x=date_diff, y = price_diff))+
  geom_point()+
  geom_smooth()+
  labs(title = "Williamsburg Property Appreciation", x = "Time Held", y = "Appreciation")+
  scale_y_continuous(limits = c(1e+03, 1e+07))+
  xlim(0, 3e+08)
```
